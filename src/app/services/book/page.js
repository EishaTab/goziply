      ...
      <div className="sticky top-24 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
        ...
        <div className="mb-4">
          ...
          <div className="text-xs text-gray-500">
            Avg: <span className="font-semibold">$134.17/hr</span>
          </div>
              ...
              {step === 1 && (
                <>
                  <div className="mb-4">
                    ...
                    />
                    {!form.locationGeometry && form.location.length > 0 && (
                      <p className="mt-2 text-sm text-red-500">
                        Please select an address from the Google dropdown.
                      </p>
                    )}
                  </div>
            ...
            <div className="mb-4 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-2">
              <div>
                <h2 className="text-2xl font-bold">
                  Taskers near your location
                </h2>
                <p className="mt-1 text-sm text-gray-500">
                  Showing {visibleUsers.length} taskers around {form.location}
                </p>
              </div>
              <p className="text-xs text-gray-400">
                Map centered within ~15km of your address.
              </p>
            </div>
